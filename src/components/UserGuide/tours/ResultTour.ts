...
const getResultTour = (hasFilters = false): ShepherdOptionsWithType[] => {
  const resultTour: ShepherdOptionsWithType[] = [
    ...
    },
    {
      ...
      ${
        hasFilters
          ? 'If you have applied some <b>filters</b> or <b>formula</b> they will appear in the sidebar as well.'
          : ''
      }</p>
    `,
      attachTo: {
